...
authenticator = IAMAuthenticator('OSsvRLHaFT7ACNDOaCM_DnYoFvDsLw51kz634gJHdhEL')
...
authenticator = IAMAuthenticator('XNJCfbA8McJoW-howdXf59YjJoRasjuhDFU1WeCTDmVJ')
...
authenticator = IAMAuthenticator('kMjudslAaNRcbuE-fKEI6_Q2xSQKvM2-n7pc0qgZc2yD')
text_to_speech = TextToSpeechV1(
    authenticator=authenticator
)

text_to_speech.set_service_url('https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/462ea31a-a0d3-41cd-9f22-d6339bc60c0f')
CHUNK = 1024
...
def read_audio(ws, timeout):
    ...
    assistant_id='037c30f1-f10e-4ab9-a036-7e54d3c7722e',
    input={
        'message_type': 'text',
         'text': txt
    }
   ...
   # with open('myfile.txt', 'r') as f:
    ...
    res = text_to_speech.synthesize(chatpot_res, accept= 'audio/mp3', voice = "en-US_HenryV3Voice").get_result()
    ...
    #with open('./output.mp3', 'wb') as audio_file:
     ...
     #   res = text_to_speech.synthesize(text, accept='audio/mp3', voice='en-GB_JamesV3Voice').get_result()
